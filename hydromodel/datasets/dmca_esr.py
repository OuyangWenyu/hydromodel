"""This module contains the functions for the DMCA-ESR method
which refers to the paper: https://doi.org/10.1029/2021WR031283
We make function for each step and name the function as the step number.
"""
...
def rainfall_runoff_event_identify(rain, flow, rain_min=0.02, max_window=100):
    ...
    rain_min : float
        minimum rainfall threshold
    max_window : int
        maximum window for calculation
    """
    # to convert from mm/h to the original units of the timeseries (mm/day)
    multiple = 24
