...
class UnitHydrographSetup(ModelSetupBase):
    ...
    def simulate(self, params: np.ndarray) -> np.ndarray:
        """
        For unit hydrograph, 'simulation' is handled within objective function.
        This method is not directly used but required by interface.
        """
        return params
...
def calibrate(
    ...
    **kwargs
    ...
    if model_name == "unit_hydrograph":
        ...
        # Traditional model setup (XAJ, GR series, etc.)
        p_and_e, qobs = data
