...
Date: 2025-02-28 15:51:47
LastEditTime: 2025-02-28 15:52:04
LastEditors: zhuanglaihong
Description: 
FilePath: /zlh/hydromodel/scripts/evaluate_gr6j.py
...
def _evaluate_1fold(train_and_test_data, cali_dir):
    ...
    param_dir = os.path.join(cali_dir, "sceua_gr6j")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp",
        dest="exp",
        help="An exp is corresponding to a data plan from calibrate_gr6j.py",
        default="expbiliuhe003",
