...
def runoff_generation(precips, evapors, w0_first, gene_params):
    """产流计算模型
...
def different_sources(precips, evapors, runoffs, initial_conditions, diff_source_params, time_interval_hours=24):
    """分水源计算
