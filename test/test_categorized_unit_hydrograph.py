...
"""
Removed tests that depended on CategorizedUnitHydrographSetup which is no longer part of the
public API. The categorized unit hydrograph is now validated via the unified calibrate interface
only.
"""
    ...
    def test_configuration_examples(self):
        ...
        for weights in [default_weights, balanced_weights, aggressive_weights]:
            ...
            for category, params in weights.items():
                ...
                assert isinstance(
                    params["peak_violation_weight"], (int, float)
                )
