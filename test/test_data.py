...
txt_file = pathlib.Path('/home/ldaning/code/biye/hydro-model-xaj/hydromodel/example/wuxi.csv')
forcing_data = pathlib.Path('/home/ldaning/code/biye/hydro-model-xaj/hydromodel/example/wuxi.csv')
json_file = pathlib.Path('/home/ldaning/code/biye/hydro-model-xaj/hydromodel/example/model_run_wuxi7/data_info.json')
npy_file = pathlib.Path('/home/ldaning/code/biye/hydro-model-xaj/hydromodel/example/model_run_wuxi7/data_info.npy')
